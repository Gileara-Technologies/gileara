...
export const posts: InsightPost[] = [
  ...
  {
    slug: "the-nightly-reconciliation-headache",
    title: "The Nightly Reconciliation Headache — and What Ends It",
    excerpt:
    ...
    author: "Julian Hagan",
    tag: "Operations",
    image: "/assets/insights/the-nightly-reconciliation-headache.jpg",
    content: [
      { type: "paragraph", text: "Mobile money solved payments and created a reconciliation problem. Sales arrive as mobile-money transfers, sometimes cash, sometimes both in one transaction — and at closing time somebody matches alerts against notes against memory, night after night." },
      { type: "heading", text: "Why manual matching fails quietly" },
      { type: "paragraph", text: "It's not discipline that's missing, it's structure. A payment recorded in a notebook has no link to the transfer reference it came from. One transposed digit and the books disagree with the wallet — and the gap only surfaces when it's expensive." },
      { type: "heading", text: "Record the channel with the sale" },
      { type: "paragraph", text: "The fix is structural: every sale records how it was paid at the moment it's entered. Our Business Operations package captures cash and mobile-money payments as separate, structured fields from day one — so the daily summary shows exactly what came through each channel, without anyone re-typing anything." },
      ...
      {
        type: "cta",
        text: "Business Operations starts at $1,625 setup + $140/month — inventory, sales, expenses, and structured payment capture included.",
