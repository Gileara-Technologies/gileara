    ...
    <>
      ...
      <main className="pt-32 pb-20 min-h-screen">
        <div className="max-w-4xl mx-auto px-6">
          <h1 className="text-4xl md:text-5xl font-bold mb-10 text-on-surface">Privacy Policy</h1>
          <div className="prose prose-invert max-w-none text-on-surface-variant space-y-6">
            ...
            <h2 className="text-2xl font-bold text-on-surface mt-8">3. Data Security</h2>
            <p>
              We implement industry-standard security measures to protect your data. However, no method of transmission over the internet is 100% secure.
            </p>
            <p>
              For any questions regarding our privacy practices, please contact us at <a href="mailto:tech.gileara@gmail.com" className="text-primary">tech.gileara@gmail.com</a>.
            </p>
          </div>
        </div>
      </main>
