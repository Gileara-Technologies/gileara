    ...
    <>
      ...
      <main className="pt-32 pb-20 min-h-screen">
        <div className="max-w-4xl mx-auto px-6">
          <h1 className="text-4xl md:text-5xl font-bold mb-10 text-on-surface">Terms of Service</h1>
          <div className="prose prose-invert max-w-none text-on-surface-variant space-y-6">
            ...
            <h2 className="text-2xl font-bold text-on-surface mt-8">1. Acceptance of Terms</h2>
            <p>
              By using this site, you signify your acceptance of these Terms of Service. If you do not agree, please do not use our site.
            </p>
            <h2 className="text-2xl font-bold text-on-surface mt-8">2. Services</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold text-on-surface mt-8">3. Intellectual Property</h2>
            <p>
            ...
            <p>
              For any legal inquiries, please contact us at <a href="mailto:tech.gileara@gmail.com" className="text-primary">tech.gileara@gmail.com</a>.
            </p>
          </div>
        </div>
      </main>
